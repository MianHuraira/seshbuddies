                  ...
                  <div className="tab-content mt-2">
                    ...
                    >
                      ...
                      <div className="align_center flex-column my-5">
                        ...
                        <h1 className="fs-17 inter-bold mt-3 mb-2">
                          No Requests
                        </h1>
                        <p className="text-center  m-auto fs-15 w-75">
                          While you don't have any pending buddy requests, why
                          not connect with some of these suggested buddies?
                        </p>
                      </div>
                      {/* ___empty Requests___ */}
                        ...
                        <div className="d-flex mt-2">
                          ...
                          <div className=" ms-auto d-flex justify-content-center align-items-center">
                            <div className="d-flex align-items-start me-2 justify-content-center">
                              ...
                              <h1 className="fs-13 inter-bold ms-1">4.9</h1>
                            </div>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      <div className="bg-white px-3 pt-2 pb-3 mb-2 radius_12 mb-2">
                        ...
                        <div className="d-flex justify-content-between">
                          <button className="reject_btn w_45">
                            Say Hello👋
                          </button>
                          <button className="reject_btn w_45">
                            Create Seshsion
                    ...
                    >
                      ...
                      <div className="bg-white px-3 pt-2 pb-3 radius_12 mb-2">
                        ...
                        <div className="d-flex justify-content-between">
                          ...
                          <Button className="btn-primary w_45">
                            Add Buddy
                          </Button>
                        </div>
                      </div>
        ...
        >
          ...
          <Modal.Body className="pb-4">
            ...
            <h1 className="black_text_lg text-center inter mb-4 fs-13 w-90 m-auto">
              Are you sure you want to reject the buddy request from
              [@Nickname]? This action cannot be undone.
            </h1>
