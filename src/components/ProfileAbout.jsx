        ...
        <div className='account_body'>
            <button className="black_text_lg d-flex justify-content-between align-items-center w-100 border-0 bg-transparent mt-2 mb-1">
                <div className="d-flex align-items-center justify-content-center">
                    ...
                    <p className="inter-semi fs-17 my-2 align_center"> <img src={guidlines} alt='' className='sheild me-2'/>Community Guidelines</p>
                </div>
            ...
            <button className="black_text_lg d-flex justify-content-between align-items-center w-100 border-0 bg-transparent mt-2 mb-1">
                <div className="d-flex align-items-center justify-content-center">
                    ...
                    <p className="inter-semi fs-17 my-2 align_center"> <img src={terms} alt='' className='sheild2 me-2'/>Terms of Service</p>
                </div>
                <img alt="" src={angle_right} className="angle-right" />
            </button>
            ...
            <button className="black_text_lg d-flex justify-content-between align-items-center w-100 border-0 bg-transparent mt-2 mb-1">
                <div className="d-flex align-items-center justify-content-center">
                    ...
                    <p className="inter-semi fs-17 my-2 align_center"> <img src={privacy_policy} alt='' className='sheild me-2'/>Privacy Policy</p>
                </div>
                <img alt="" src={angle_right} className="angle-right" />
            </button>
            ...
            <button className="black_text_lg d-flex justify-content-between align-items-center w-100 border-0 bg-transparent mt-2 mb-1">
                <div className="d-flex align-items-center justify-content-center">
                    ...
                    <p className="inter-semi fs-17 my-2 align_center"> <img src={highlights} alt='' className='sheild me-2'/>Privacy Highlights for Teens</p>
                </div>
                <img alt="" src={angle_right} className="angle-right" />
            </button>
            ...
            <button className="black_text_lg d-flex justify-content-between align-items-center w-100 border-0 bg-transparent mt-2 mb-1">
                <div className="d-flex align-items-center justify-content-center">
                    ...
                    <p className="inter-semi fs-17 my-2 align_center"> <img src={copyright} alt='' className='sheild me-2'/>Copyright Policy</p>
                </div>
                <img alt="" src={angle_right} className="angle-right" />
            </button>
        </div>
