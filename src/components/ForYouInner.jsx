            ...
            <div className="tab-content">
                    ...
                    <div className='mt-3'>
                        ...
                        <div className='bg-white px-3 pt-2 pb-3 radius_14 mt-3'>
                            ...
                            <div className='d-flex align-items-center justify-content-between mt-3'>
                                ...
                                <button className='yourBuddyBtn3'>Decline</button>
                                <button className='yourBuddyBtn3 btnGreen'>Accept</button>
                            </div>
                        </div>
                        {/* ___request___ */}
                        {/* ___request___ */}
                        <div className='bg-white px-3 pt-2 pb-3 radius_14 mt-3'>
                            ...
                            <div className='d-flex align-items-center justify-content-between mt-3'>
                                ...
                                <button className='yourBuddyBtn2'>Cancel</button>
                            </div>
                        </div>
                        {/* ___request___ */}
                    </div>
                ...
                <div className={`tab-pane px-2 ${forYou === 'tab2' ? 'active' : ''}`} id="tab2" >
                    ...
                    <div className='bg-white px-3 pt-2 pb-3 radius_14 mt-3'>
                        ...
                        <p className='text_black_md fs-14'>Your response is pending.</p>
                        <div className='d-flex align-items-center justify-content-between mt-3'>
                            <NavLink to={"/pending"} className='yourBuddyBtn3'>View Details</NavLink>
                            <button className='yourBuddyBtn3'>Decline</button>
                            <button className='yourBuddyBtn3 btnGreen'>Accept</button>
                        </div>
                    </div>
