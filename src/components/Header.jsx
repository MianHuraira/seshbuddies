  ...
  return (
    <>
      <Navbar
        expand="lg"
        className={`${
          getPath === "/live_stream" ? "nav_gbg" : "nav_bg"
        }  nav_bar`}
      >
        <div className="container-xxl px-0">
          <Navbar.Brand className="d-flex align-items-center  ms-2">
            <NavLink to={"/"}>
              ...
              <img className="logo_text ms-2" src={logo_text} alt="" />
            </NavLink>
          </Navbar.Brand>
          {/* search div */}

          <NavLink
            to={"/search"}  style={{ backgroundColor: getPath === "/live_stream" ? "rgba(45, 61, 56, 0.3)" : "", }}
          ...
          >
            <img
              ...
              alt=""
            />
            {/* <BiSearch className="icon_size_tab me-2" /> */}
            <Form.Control
              type="email"
          ...
          <div className="nav_item clr_chng">
            <NavLink
              className="me-3"
            ...
            <NavLink className="me-3" to={"calendar"}>
              <div className="main_noti_div">
                <div className="noti_div"></div>
          ...
          <div className="d-flex align-items-center clr_chng lg_left">
            <NavLink to={"/notification"} className="icon_div me-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <NavLink to={"/chat"} className="icon_div me-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
